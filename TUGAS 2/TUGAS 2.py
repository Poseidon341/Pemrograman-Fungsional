...
add_expense_interactively = lambda expenses: add_expense(
    expenses,
    input("Masukkan tanggal pengeluaran (YYYY-MM-DD): "),
    input("Masukkan deskripsi pengeluaran: "),
    int(input("Masukkan jumlah pengeluaran: "))
)
view_expenses_by_date = lambda expenses: view_expenses_by_date_lambda(expenses, input("Masukkan tanggal (YYYY-MM-DD): "))
view_expenses_report = lambda expenses: view_expenses_report_lambda(expenses)
get_user_input = lambda command: int(input(command))

def view_expenses_by_date_lambda(expenses, date):
...
def view_expenses_report_lambda(expenses):
